...
set_property PACKAGE_PIN V4 [get_ports {DISP_EN[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {DISP_EN[0]}]
set_property PACKAGE_PIN W4 [get_ports {DISP_EN[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {DISP_EN[1]}]


##Buttons
set_property PACKAGE_PIN U18 [get_ports PAUSE_BTN]						
	set_property IOSTANDARD LVCMOS33 [get_ports PAUSE_BTN]
#set_property PACKAGE_PIN T18 [get_ports btnU]						
#	set_property IOSTANDARD LVCMOS33 [get_ports btnU]
#set_property PACKAGE_PIN W19 [get_ports RESET_BTN]						
#	set_property IOSTANDARD LVCMOS33 [get_ports RESET_BTN]
set_property PACKAGE_PIN T17 [get_ports MODE_BTN]						
